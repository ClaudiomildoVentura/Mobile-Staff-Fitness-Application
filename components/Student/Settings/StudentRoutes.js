...
import {
  ...
  createMaterialTopTabNavigator, DrawerActions, Header
...
/*const StudentTabsNavigator = createMaterialTopTabNavigator(
    { 
     "Página Inicial":StudentProfileScreen, 
     "Agenda": StudentProfileScreen,
...
/*const StudentDrawerNavigator = createDrawerNavigator(
  {
    StudentHome: StudentTabsNavigator,
    ScheduleScreen: StudentProfileScreen,
    StudentsListScreen: StudentProfileScreen    
    },
    {
